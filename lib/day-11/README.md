...
- If a seat is **_empty_** (`L`) and there are **_no_** occupied seats - adjacent to it, the seat becomes **_occupied._**
- If a seat is **_occupied_** (`#`) and **_four or more_** seats adjacent - to it are also occupied, the seat becomes **_empty._**
